...
for ((i=0;i<16;++i)); do 
    ...
    ./client -l $1 -t 500 -k pippo -L -s config.h:qua -s client:qua -s libchatty.a:qua -p &
    ...
    ./client -l $1 -k utente1 -R 5 -S Connections/connections.o:utente2 -p
    ./client -l $1 -k utente2 -R 5 -p -S config.h:utente1 
