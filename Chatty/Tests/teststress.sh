...
for ((i=0;i<16;++i)); do
    ...
    ./client -l $1 -t 500 -k pippo -L -s ./Server/chatty.o:qua -s client:qua -s libchatty.a:qua -p &
    ...
    ./client -l $1 -k utente2 -R 5 -p -S ./Server/chatty.o:utente1

    ./client -l $i -C utente1
    ./client -l $i -C utente2
    wait
    echo "===========================>TEST n°$i FINEEE!!!!!!!!!!!!!!!!!!"
done
